...
class QwenVLDescriptionGenerator:
    def __init__(self, 
                 model_name: str = "models\qwen2_vl_2b_instruct_local", 
    ...
    def generate_description(self, input_path: str, 
                              user_query: str = "Describe this input.", 
                              max_new_tokens: int = 128) -> str:
        """
        Generate a description or answer a user query for an image or video file.
        
        Args:
            input_path (str): Path to the input file
            user_query (str): User's question or description request
            max_new_tokens (int): Maximum number of tokens to generate
        
        Returns:
            str: Generated description or answer
        """
        # Process input file
        ...
        messages = [
            {
                "role": "user", 
                "content": [input_data, {"type": "text", "text": user_query}]
            }
        ]
